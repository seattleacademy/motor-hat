...
module.exports = function DC(opts) {
  ...
  /**
   * Sets DC motor speed.
   * The speed can be set as a percentage, from 0% to 100%. To change the actual top speed, the actual
   * voltage supplied to the motor needs to be controlled by hardware (get a higher voltage source).
   *
   * @instance
   ...
   * @returns {module:MotorHat/DC~dc} Returns initialized DC controller object, either directly
  ...
  // * @namespace module:MotorHat/DC~dc
  /**
